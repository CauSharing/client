...
{/*             <div>{user.name}</div> */}
            ...
            <Link to="/home"><button className="sidebar__menu">Home</button></Link>
            <button onClick={handleClick} className="sidebar__menu">Add Friends</button>
            <Link to="/setting"><button className="sidebar__menu">Setting</button></Link>
            <Link to="/"><div className="sidbar__logout">Logout</div></Link>
        </div>
    );
}
